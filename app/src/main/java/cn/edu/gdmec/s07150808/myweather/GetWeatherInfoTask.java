...
public class GetWeatherInfoTask extends AsyncTask<String,Void,List<Map<String,Object>>> {
    ...
    private static String key="&key=39f70fb524d93d14980a6010e1d2c9d0";
    ...
    protected void onPostExecute(List<Map<String, Object>> maps) {
        ...
        if(maps.size()>0){
            ...
            SimpleAdapter simpleAdapter=new SimpleAdapter(context,maps,R.layout.weather_item,new String[]{"temperature","weather","data","week","weather_icon"},new int[]{R.id.temperature,R.id.weather,R.id.date,R.id.week,R.id.weather_icon});
